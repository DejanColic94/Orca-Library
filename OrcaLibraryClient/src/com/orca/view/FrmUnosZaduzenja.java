...
public class FrmUnosZaduzenja extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmUnosZaduzenja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmUnosZaduzenja dialog = new FrmUnosZaduzenja(new javax.swing.JFrame(), true);
